...
Controleer vóór ieder nieuw uitkijkje eerst dit register.

Een voorstel wordt niet alleen op exacte doublure getoetst, maar op vijf assen:

1. **Werk / bron** — komt hetzelfde werk, fragment of beeld al voor?
2. **Maker / traditie** — leunen we opnieuw op dezelfde maker, school of canon?
3. **Medium** — worden uitkijkjes te vaak schilderijen of museumobjecten?
4. **Periode / regio** — ontstaat een te zware concentratie in West-Europa of de 19e/20e eeuw?
5. **Functie** — doen de uitkijkjes steeds hetzelfde filosofische werk?

Exact hetzelfde werk wordt in beginsel maar één keer gebruikt. Dezelfde maker kan terugkeren wanneer een tweede werk aantoonbaar een andere functie vervult, maar hergebruik draagt dan een expliciete rechtvaardigingslast.
...
- **concretiseren** — een abstract onderscheid lichamelijk of zichtbaar maken;
- **vertragen** — de lezer even uit de argumentatieve stroom halen;
- **ontregelen** — een vanzelfsprekende categorie laten schuiven;
- **tegenbeeld** — laten zien waar een begrip kan knellen, zonder het tegenargument uit te schrijven;
- **schaalverschuiving** — hetzelfde vraagstuk op een andere schaal laten verschijnen;
- **humor / lucht** — spanning losmaken zonder de inhoud te bagatelliseren;
- **culturele verbreding** — een andere kennistraditie of beeldtaal laten binnenkomen zonder haar te annexeren.

Een uitkijkje mag meerdere effecten hebben, maar noteer één primaire functie. Zo wordt zichtbaar wanneer bijvoorbeeld bijna alles alleen nog 'concretiseert'.
...
- architectuur, ambacht en materiële cultuur;
- muziek, performance en theater;
- cartoons, strips en kindertelevisie;
- mondelinge en literaire vormen buiten de Europese canon;
