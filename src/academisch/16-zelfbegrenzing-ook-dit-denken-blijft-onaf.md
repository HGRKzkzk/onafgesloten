...
Daarnaast sluit het hoofdstuk aan bij reflexieve methodologie in sociale wetenschappen en antropologie: degene die analyseert staat niet buiten de beschrijving, en selectie van categorieën, casussen en bronnen is zelf onderdeel van het onderzoeksobject.
...
3. **Conceptuele claims.** Projectbegrippen moeten onderscheidend, begrensd en bruikbaar zijn. Hun falen kan blijken uit redundantie, vaagheid, slechte overdraagbaarheid of het ontbreken van analytische meerwaarde.
4. **Normatieve claims.** Wederkerigheid, afwendbaar lijden en corrigeerbare macht moeten met argumenten worden verdedigd en kunnen botsen met andere legitieme waarden. Zij worden niet door empirische data alleen bewezen of ontkracht.

Deze laagdifferentiatie voorkomt twee fouten. De eerste is pseudo-falsifieerbaarheid: doen alsof een filosofisch project één empirische voorspelling heeft waarop het geheel kan vallen. De tweede is immunisering: iedere kritiek afweren met de mededeling dat de claim slechts filosofisch bedoeld was.

Een nuttige toets is daarom domeinspecifiek: welk soort claim wordt hier gemaakt, en wat zou binnen dát register als relevante tegeninformatie tellen?

## Tegenlicht

### 1. Zelfkritiek kan performatief worden

Een theorie kan zeer overtuigend beschrijven hoe open zij staat voor kritiek zonder ooit een centraal begrip op te geven. Reflexiviteit wordt dan stijl in plaats van mechanisme.

Daarom is het onvoldoende om tegenargumenten, beperkingen en alternatieve tradities in de tekst op te nemen. Er moeten historische sporen van werkelijk verlies mogelijk zijn: begrippen die verdwijnen, claims die worden teruggeschaald, hoofdstukken die veranderen omdat externe kritiek beter bleek.

### 2. Falsificatie kan zelf te streng of te simpel worden
...
### 4. Begripsafbouw botst met projectidentiteit
...
De praktische toets blijft daarom:

> Kan deze kritiek iets van het project kosten?

Als het antwoord structureel nee is, is corrigeerbaarheid vooral retorisch.
...
- Rudolf Carnap, "Empiricism, Semantics, and Ontology" — relevant als historische achtergrond bij expliciete keuze van begripskaders.
- Herman Cappelen, *Fixing Language: An Essay on Conceptual Engineering*.
- Alexis Burgess & David Plunkett, werk over conceptual ethics en conceptuele normativiteit.
- Sally Haslanger, werk over analytische en amelioratieve conceptuele projecten.
