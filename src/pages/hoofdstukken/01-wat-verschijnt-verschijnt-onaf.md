...
order: 1
title: "Wat verschijnt, verschijnt onaf"
description: "Over vorm, grens en waarom wat werkelijk verschijnt nooit zonder meer het hele verhaal is."
slug: "01-wat-verschijnt-verschijnt-onaf"
...
We zijn gewend te vragen wat iets *is*. Wie is deze persoon? Wat voor relatie is dit? Wat voor organisatie? Wat voor probleem?

Dat is geen slechte gewoonte. Om iets te kunnen herkennen, moeten we verschil kunnen zien. Een boom is geen wolk, mijn lichaam is niet het jouwe, een belofte is iets anders dan een wens. Zonder onderscheid zou niets duidelijk kunnen verschijnen. Maar precies daar kan iets misgaan: wat we herkennen als een vorm, gaan we gemakkelijk behandelen alsof die vorm zichzelf volledig verklaart.

Een mens wordt zijn diagnose. Een medewerker zijn dossier. Een relatie wordt het verhaal dat er na afloop over wordt verteld. Een organisatie wordt haar organogram. Een misstap wordt een karakter. Wat zichtbaar werd doordat we een grens trokken, krijgt ongemerkt de status van het geheel.

De zin waarmee dit hoofdstuk begint probeert die beweging te onderbreken:
...
De makkelijke uitweg is zeggen: *dat was ik niet.* Maar dat klopt vaak niet. Het was jouw stem, jouw lichaam, jouw handeling. De gevolgen verdwijnen niet omdat je jezelf er achteraf niet volledig in herkent. De andere makkelijke uitweg is: *dus zo ben ik kennelijk.* Ook dat gaat te snel.
...
<aside class="uitkijkje uitkijkje--beeld uitkijkje--luchtgat">
  ...
  <figure class="uitkijkje__figure">
    <img
      src="https://commons.wikimedia.org/wiki/Special:Redirect/file/Jim_Henson%2C_creator%2C_The_Muppets_-full.jpg"
      alt="Jim Henson tussen verschillende Muppets in een portret uit 1979."
      loading="lazy"
    />
    <figcaption>
      Bernard Gotfryd, <em>Jim Henson, creator, The Muppets</em>, 1979.
      Library of Congress / Wikimedia Commons. Geen bekende beperkingen op publicatie.
    </figcaption>
  </figure>
  ...
  <p>
    Dat is misschien een van de charmes van de Muppets: niemand hoeft eerst hetzelfde te worden voordat er
    gezamenlijk iets kan gebeuren. De voorstelling bestaat niet doordat de chaos definitief is opgelost, maar
    doordat er nét genoeg samenhang blijft om het doek nog een keer open te laten gaan.
  </p>

  <p class="uitkijkje__source">
    <a href="https://commons.wikimedia.org/wiki/File:Jim_Henson,_creator,_The_Muppets_-full.jpg" target="_blank" rel="noopener noreferrer">
      Wikimedia Commons — foto en rechteninformatie
    </a>
    ·
    <a href="https://www.loc.gov/pictures/item/2020731151/" target="_blank" rel="noopener noreferrer">
      Library of Congress — oorspronkelijke collectie
    </a>
  </p>
</aside>
...
Hier wordt onafgeslotenheid praktisch belangrijk. We verwarren stabiliteit gemakkelijk met gezondheid, maar een vorm kan jarenlang standhouden doordat precies datgene wat haar zou kunnen corrigeren geen ruimte krijgt. Een organisatie kan efficiënt lijken omdat medewerkers voortdurend de fouten van het systeem opvangen. Een gezin kan rustig lijken omdat één persoon alle conflicten inslikt. Een mens kan betrouwbaar blijven functioneren door signalen van uitputting steeds verder uit zijn bewustzijn te duwen.
