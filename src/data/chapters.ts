...
export const chapters: Chapter[] = [
  ...
  { order: 13, label: '13', title: 'Drie toetsgevallen', slug: '14-drie-toetsgevallen-wat-verandert-er-wanneer-dit-denken-iets-moet-doen', summary: 'Drie concrete situaties: twee waarin het begrippenkader iets kan toevoegen en één waarin het expliciet moet wijken.', main: true },
