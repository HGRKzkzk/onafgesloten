...
export const chapters: Chapter[] = [
  ...
  { order: 99, label: 'Kern', title: 'De kern in vierentwintig zinnen', slug: '99-kern-in-twintig-zinnen', summary: 'Een compacte ingang voor wie eerst de contouren van het project wil zien.' },
