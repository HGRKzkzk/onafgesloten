...
export const chapters: Chapter[] = [
  ...
  { order: 12, label: '12', title: 'Velden, instituties en georganiseerde sluiting', slug: '13-velden-instituties-en-georganiseerde-sluiting', summary: 'Over macht, draagstructuren, onafhankelijke correctie en instituties die door gevolgen veranderbaar moeten blijven.', main: true },
  ...
  { order: 99, label: 'Kern', title: 'De kern in tweeëntwintig zinnen', slug: '99-kern-in-twintig-zinnen', summary: 'Een compacte ingang voor wie eerst de contouren van het project wil zien.' },
